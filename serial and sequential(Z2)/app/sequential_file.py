...
class SequentialFile(BinaryFile):
    ...
    def insert_record(self, rec):
        ...
        self.insert_record_without_check(rec)

    def insert_record_without_check(self, rec):
    ...
    def print_file(self):
        ...
        with open(self.filename, "rb") as f:
            while True:
                ...
                for j in range(self.blocking_factor):
                    print("Syllable {0} ".format(j + 1), end="")
                    print(block[j])
